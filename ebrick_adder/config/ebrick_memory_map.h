...
// ** Address ranges for the 1-bit adder core **
#define ADDER_BASE_ADDR 0xA0000000
#define ADDR_AP_CTRL (ADDER_BASE_ADDR + 0x00)
#define ADDR_IN_A    (ADDER_BASE_ADDR + 0x10)
#define ADDR_IN_B    (ADDER_BASE_ADDR + 0x18)
#define ADDR_OUT_C   (ADDER_BASE_ADDR + 0x20)
