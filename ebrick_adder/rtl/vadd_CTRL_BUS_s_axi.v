...
#(parameter
    ...
    output wire [31:0]                   in_a,
    output wire [31:0]                   in_b,
...
localparam
    ...
    ADDR_IER          = 6'h08,
    ADDR_ISR          = 6'h0c,
    ADDR_IN_A_DATA_0  = 6'h10,
    ADDR_IN_A_CTRL    = 6'h14,
    ADDR_IN_B_DATA_0  = 6'h18,
    ADDR_IN_B_CTRL    = 6'h1c,
    ADDR_OUT_C_DATA_0 = 6'h20,
    ADDR_OUT_C_CTRL   = 6'h24,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_in_a = 'b0;
    reg  [31:0]                   int_in_b = 'b0;
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_A_DATA_0)
            int_in_a[31:0] <= (WDATA[31:0] & wmask) | (int_in_a[31:0] & ~wmask);
    end
end
